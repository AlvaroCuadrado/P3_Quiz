...
//Es un array de objetos, donde cada objeto tiene los atributos question y
//answer para guardar el texto de la pregunta y la respuesta.
//
...
*Este método carga el contenido el fichero DB_FILENAME en la variable
...
*existe, y se poducirá el error ENOENT. En este caso se salva el contenido inicial
*almacenado en quizzes.
*Si se produce otro tipo de error, se lanza una excepción que abortará
*la ejecuciónd del programa.
*/
...
*returns {question, answer}. Devuelve el objeto quiz en la posición dada.
*/
